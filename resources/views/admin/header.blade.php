        ...
        <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                ...
                <li class="relative" x-data="{ isProfileMenuOpen: false }">
                    <button class="flex items-center justify-center align-middle rounded-full  focus:outline-none" @click="isProfileMenuOpen = !isProfileMenuOpen" @keydown.escape="isProfileMenuOpen = false" aria-label="Account" aria-haspopup="true">
                        <img class="object-cover w-8 h-8 rounded-full" src="{{ asset('images/awok.jpg') }}" alt="" aria-hidden="true" />
                        <span class="p-2 text-black font-bold text-sm">{{ auth()->user()->name }}</span>
                    </button>
